...
assert.match(moduleSource, /#!name=YouTube 自动简中双语字幕 v15/);
assert.match(moduleSource, /#!version=15\.0/);
...
const translateBundle = await readFile("Translate.response.youtube-fix-v15.bundle.js", "utf8");
assert.match(translateBundle, /Hey-sayiwanna YouTube Translate FIX 15 active/);
...
console.log("PASS: stable module path and all YouTube v15 runtime files are independently hosted");
