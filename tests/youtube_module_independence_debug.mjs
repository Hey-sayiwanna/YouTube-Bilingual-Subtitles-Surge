...
const runtimeBundles = [
	...
	"Translate.response.youtube-fix-v23.bundle.js",
];

assert.match(moduleSource, /#!name=YouTube 自动简中双语字幕 v23/);
assert.match(moduleSource, /#!version=23\.0/);
...
assert.match(moduleSource, new RegExp(`${repository}/main/Translate\\.response\\.youtube-fix-v23\\.bundle\\.js`));
...
const translateBundle = await readFile("Translate.response.youtube-fix-v23.bundle.js", "utf8");
assert.match(translateBundle, /Hey-sayiwanna YouTube Translate FIX 23 active/);
