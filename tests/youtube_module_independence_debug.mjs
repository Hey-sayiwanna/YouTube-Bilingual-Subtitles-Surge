...
const runtimeBundles = [
	...
	"Translate.response.youtube-fix-v21.bundle.js",
];

assert.match(moduleSource, /#!name=YouTube 自动简中双语字幕 v21/);
assert.match(moduleSource, /#!version=21\.0/);
...
assert.match(moduleSource, new RegExp(`${repository}/main/Translate\\.response\\.youtube-fix-v21\\.bundle\\.js`));
...
const translateBundle = await readFile("Translate.response.youtube-fix-v21.bundle.js", "utf8");
assert.match(translateBundle, /Hey-sayiwanna YouTube Translate FIX 21 active/);
